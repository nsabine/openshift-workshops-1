...
parksmap-py-1-hx0kv   1/1       Running   0          2m
----
...
[source]
----
oc get pod parksmap-py-1-hx0kv -o yaml
----
...
parksmap-py   172.30.169.213   <none>        8080/TCP   3h
----

In the above output, we can see that we have a *Service* named `parksmap-py` with an
...
[source]
----
oc get service parksmap-py -o yaml
----
...
metadata:
  ...
  selfLink: /api/v1/namespaces/{{EXPLORE_PROJECT_NAME}}{{USER_SUFFIX}}/services/parksmap-py
...
----
NAME               READY     STATUS    RESTARTS   AGE
parksmap-py-1-hx0kv   1/1       Running   0          3h
----
...
[source]
----
oc describe service parksmap-py
----
