...
OpenShift to stand up the `parksmap-py` image:
...
you told OpenShift to stand up the `parksmap-py` image:
...
[source]
----
oc scale --replicas=2 dc/parksmap-py
----
...
parksmap-py-1-8g6lb   1/1       Running   0          1m
parksmap-py-1-hx0kv   1/1       Running   0          4h
----
...
----
NAME       ENDPOINTS                                   AGE
parksmap-py   10.1.0.5:8080,10.1.1.5:8080                 4h
----
...
image::/images/parksmap-py-scaled.png[Scaling]
...
[source]
----
oc delete pod parksmap-py-1-hx0kv
----
...
Based on these health checks, if OpenShift decided that our `parksmap-py`
