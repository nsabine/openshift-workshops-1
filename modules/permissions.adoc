...
`system:serviceaccount:userXXX-parks:default`. It's a nifty shortcut.
...
access to your `userXXX-parks` project using the following command:

[source]
----
oc policy add-role-to-user view userXXX
----
...
This time we'll use the web console. Find your `userXXX-parks` project,
