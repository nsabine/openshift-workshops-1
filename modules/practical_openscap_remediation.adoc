...
After reviewing the HTML report we can see that a lot of rules are failing. To put machine into
compliance we have to perform a so-called “remediation” and in most cases also reboot the machine.
