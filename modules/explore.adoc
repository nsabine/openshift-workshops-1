...
[source]
----
$ oc login https://console.devconf.pixy.io:8443
----
...
[source]
----
Now using project userXXX-parks on server "https://{{CONSOLE_ADDRESS}}".
----
...
Click on the *userXXX-parks* project. When you click on the
*userXXX-parks* project, you will be taken to the project overview page
